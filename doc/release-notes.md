...
GCC 4.8.x
--------------
The minimum version of GCC required to compile Globaltoken Core is now 4.8. No effort will be
...
Globaltoken Core now has more flexibility in where the wallets directory can be
located. Previously wallet database files were stored at the top level of the
globaltoken data directory. The behavior is now:
