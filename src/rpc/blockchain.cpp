...
UniValue getblockchaininfo(const JSONRPCRequest& request)
{
    ...
    UniValue globaltoken_hardforks(UniValue::VOBJ);
    globaltoken_hardforks.pushKV("activated", consensusParams.Hardfork1.IsActivated(tip->nTime));
    globaltoken_hardforks.pushKV("activation_time", (int64_t)consensusParams.Hardfork1.GetActivationTime());
    globaltoken_hardforks.pushKV("activation_height", (int64_t)consensusParams.Hardfork1.GetActivationHeight());
