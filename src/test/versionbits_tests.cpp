...
public:
    ...
    int Period(const Consensus::Params& params, int checkHeight) const override { return 1000; }
    int Threshold(const Consensus::Params& params, int checkHeight) const override { return 900; }
