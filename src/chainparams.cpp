...
public:
    CMainParams() {
        ...
        consensus.Hardfork2.Initialize(2 /* Hardfork ID */, 1564660800 /* Hardfork Activation Time */, 700000 /* Hardfork Activation Height - unknown yet */, uint256() /* Hardfork Activation Blockhash - unknown yet */);
        ...
        consensus.aPOWAlgos[ALGO_YESCRYPT_R16V2]  = CPOWAlgoProperties(ALGO_YESCRYPT_R16V2, uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_YESCRYPT_R24]    = CPOWAlgoProperties(ALGO_YESCRYPT_R24, uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_YESCRYPT_R8]     = CPOWAlgoProperties(ALGO_YESCRYPT_R8, uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_YESCRYPT_R32]    = CPOWAlgoProperties(ALGO_YESCRYPT_R32, uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_X25X]            = CPOWAlgoProperties(ALGO_X25X, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_ARGON2D]         = CPOWAlgoProperties(ALGO_ARGON2D, uint256S("0009ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_ARGON2I]         = CPOWAlgoProperties(ALGO_ARGON2I, uint256S("0009ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_CPU23R]          = CPOWAlgoProperties(ALGO_CPU23R, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_YESPOWER]        = CPOWAlgoProperties(ALGO_YESPOWER, uint256S("0003ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_X21S]            = CPOWAlgoProperties(ALGO_X21S, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_X16S]            = CPOWAlgoProperties(ALGO_X16S, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_X22I]            = CPOWAlgoProperties(ALGO_X22I, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        ...
        consensus.aPOWAlgos[ALGO_HONEYCOMB]       = CPOWAlgoProperties(ALGO_HONEYCOMB, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        ...
        consensus.aPOWAlgos[ALGO_RICKHASH]        = CPOWAlgoProperties(ALGO_RICKHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        ...
        consensus.nOldRuleChangeActivationThreshold = 8; // 95% of 2016 // Changed to 8 because 9.5 is up to ten.
        consensus.nOldMinerConfirmationWindow = 10; // nPowTargetTimespan / nPowTargetSpacing
        consensus.nNewRuleChangeActivationThreshold = 13680; // 95% of 14400 
        consensus.nNewMinerConfirmationWindow = 14400; // Because we use Multialgo, we want a bigger timespan. Get the data of the last 10 days for new Rules.
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000134b2af90229877f1cc");
        ...
        base58Prefixes[SCRIPT_ADDRESS_NEW] = std::vector<unsigned char>(1,141); // The new address format will start with 'y' or 'z'
        ...
        chainTxData = ChainTxData{
            // Data as of block 14b4ed452d4561f653854001e5a84036e4cf611bdc3e27edb2317fc9ed52ba09 (height 676488).
            1558828913, // * UNIX timestamp of last known number of transactions
            1008167,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0.0306467   // * estimated number of transactions per second after that timestamp
        };
...
public:
    CTestNetParams() {
        ...
        consensus.aPOWAlgos[ALGO_X16R]            = CPOWAlgoProperties(ALGO_X16R, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_LYRA2REV3]       = CPOWAlgoProperties(ALGO_LYRA2REV3, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_YESCRYPT_R16V2]  = CPOWAlgoProperties(ALGO_YESCRYPT_R16V2, uint256S("0003ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_YESCRYPT_R24]    = CPOWAlgoProperties(ALGO_YESCRYPT_R24, uint256S("0003ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_YESCRYPT_R8]     = CPOWAlgoProperties(ALGO_YESCRYPT_R8, uint256S("0003ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_YESCRYPT_R32]    = CPOWAlgoProperties(ALGO_YESCRYPT_R32, uint256S("0003ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_X25X]            = CPOWAlgoProperties(ALGO_X25X, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_ARGON2D]         = CPOWAlgoProperties(ALGO_ARGON2D, uint256S("0009ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_ARGON2I]         = CPOWAlgoProperties(ALGO_ARGON2I, uint256S("0009ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_CPU23R]          = CPOWAlgoProperties(ALGO_CPU23R, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        ...
        consensus.fPowNoRetargeting = false;
        consensus.nOldRuleChangeActivationThreshold = 8; // 75% for testchains
        consensus.nOldMinerConfirmationWindow = 10; // nPowTargetTimespan / nPowTargetSpacing
        consensus.nNewRuleChangeActivationThreshold = 10800; // 75% for testchains
        consensus.nNewMinerConfirmationWindow = 14400; // Because we use Multialgo, we want a bigger timespan. Get the data of the last 10 days for new Rules.
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1199145601; // January 1, 2008
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1230767999; // December 31, 2008
        ...
        base58Prefixes[SCRIPT_ADDRESS_NEW] = std::vector<unsigned char>(1,8); // The new address format will start with '4'
...
public:
    CRegTestParams() {
        ...
        consensus.aPOWAlgos[ALGO_YESPOWER]        = CPOWAlgoProperties(ALGO_YESPOWER, uint256S("3fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        consensus.aPOWAlgos[ALGO_X21S]            = CPOWAlgoProperties(ALGO_X21S, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        ...
        consensus.aPOWAlgos[ALGO_RICKHASH]        = CPOWAlgoProperties(ALGO_RICKHASH, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), 1);
        ...
        consensus.nOldRuleChangeActivationThreshold = 108; // 75% for testchains
        consensus.nOldMinerConfirmationWindow = 144; // Faster than normal for regtest (144 instead of 2016)
        consensus.nNewRuleChangeActivationThreshold = 5400; // 75% for testchains
        consensus.nNewMinerConfirmationWindow = 7200; // Because we use Multialgo, we want a bigger timespan. Get the data of the last 5 days for new Rules. (regtest-only)
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
