 ...
 *
 * Blockformat : Legacy Blocks.
 */
class CDefaultAuxPow : public CMerkleTx
{
...
public:
  ...
  CDefaultBlockHeader parentBlock;

public:

  /* Prevent accidental conversion.  */
  inline explicit CDefaultAuxPow (CTransactionRef txIn)
    : CMerkleTx (txIn)
  {}
  ...
  {
    return parentBlock.GetPoWHash (nAlgo);
  }
...
/**
 * Blockformat: Equihash
*/
class CEquihashAuxPow : public CMerkleTx
{
...
public:
  ...
  /** Parent block header (on which the real PoW is done).  */
  CEquihashBlockHeader parentBlock;

public:

  /* Prevent accidental conversion.  */
  inline explicit CEquihashAuxPow (CTransactionRef txIn)
    : CMerkleTx (txIn)
  {}

  inline CEquihashAuxPow ()
    : CMerkleTx ()
  {}
