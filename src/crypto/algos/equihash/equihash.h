...
public:
    ...
    int InitialiseState(eh_HashState& base_state, const std::string strPersonalstring="ZcashPoW");
...
#define EhInitialiseState(n, k, base_state, strPersonalstring)  \
    if (n == 96 && k == 3) {                 \
        Eh96_3.InitialiseState(base_state, strPersonalstring);  \
    } else if (n == 200 && k == 9) {         \
        Eh200_9.InitialiseState(base_state, strPersonalstring); \
    } else if (n == 144 && k == 5) {         \
        Eh144_5.InitialiseState(base_state, strPersonalstring); \
    } else if (n == 96 && k == 5) {          \
        Eh96_5.InitialiseState(base_state, strPersonalstring);  \
    } else if (n == 48 && k == 5) {          \
        Eh48_5.InitialiseState(base_state, strPersonalstring);  \
    } else if (n == 192 && k == 7) {         \
        Eh192_7.InitialiseState(base_state, strPersonalstring); \
    } else {                                 \
