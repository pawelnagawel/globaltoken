    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    // draw copyright stuff
    {
		...
		const int y_glt = paddingTop+titleCopyrightVSpace+25;
...
static void ShowProgressAsDouble(SplashScreen *splash, const std::string &title, double dProgress)
{
    InitMessage(splash, title + strprintf("\n%.2f", dProgress) + "%");
}
...
void SplashScreen::subscribeToCoreSignals()
{
    ...
    uiInterface.ShowProgressAsDouble.connect(boost::bind(ShowProgressAsDouble, this, _1, _2));
#ifdef ENABLE_WALLET
...
void SplashScreen::unsubscribeFromCoreSignals()
{
    ...
    uiInterface.ShowProgressAsDouble.disconnect(boost::bind(ShowProgressAsDouble, this, _1, _2));
#ifdef ENABLE_WALLET
